...
const navItems = [
  ...
  { path: "/architecture", icon: Cpu, label: "Structural View", sub: "Architecture" },
  { path: "/sparsity", icon: BarChart3, label: "Sparsity View", sub: "Sparse Brain" },
  { path: "/graph", icon: Network, label: "Topology View", sub: "Graph Brain" },
  { path: "/monosemanticity", icon: Brain, label: "Concept View", sub: "Monosemanticity" },
  { path: "/hebbian", icon: Zap, label: "Dynamics View", sub: "Hebbian" },
  { path: "/merge", icon: GitMerge, label: "Composition View", sub: "Model Merge" },
...
export function Layout() {
  ...
  return (
    <div className="min-h-screen flex noise-overlay vignette" style={{ background: '#070D12' }}>
      {/* ─── Sidebar ─── */}
      <aside
      ...
      >
        ...
        <div className="p-5" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          <NavLink to="/" className="flex items-center gap-3 group">
            ...
            <div>
              <h1 className="font-semibold text-[#E2E8F0] text-sm tracking-tight">BDH Suite</h1>
              <p className="text-[10px] text-[#4A5568] tracking-wider uppercase">Neural Observatory</p>
            </div>
          </NavLink>
        </div>
              ...
              {({ isActive }) => (
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    {item.sub !== item.label && (
                      <span className="text-[10px] text-[#4A5568] block">{item.sub}</span>
                    )}
                  </div>
                </motion.div>
              )}
            ...
            >
              ...
              >
                ...
                <span>
                  ...
                  {" — "}run{" "}
                  <code className="px-1.5 py-0.5 rounded text-xs font-mono text-amber-300" style={{ background: 'rgba(255,255,255,0.05)' }}>
