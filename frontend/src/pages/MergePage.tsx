      ...
      <div className="grid md:grid-cols-3 gap-6 mb-6">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="glass-card p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between"><span className="text-gray-400">Parameters</span><span className="font-mono">25M</span></div>
            <div className="flex justify-between"><span className="text-gray-400">Neurons/Head</span><span className="font-mono">8,192</span></div>
            <div className="flex justify-between"><span className="text-gray-400">BLEU (En→Fr)</span><span className="font-mono text-green-400">32.4</span></div>
            <div className="flex justify-between"><span className="text-gray-400">BLEU (En→Pt)</span><span className="font-mono text-red-400">2.1</span></div>
          </div>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="glass-card p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between"><span className="text-gray-400">Parameters</span><span className="font-mono">25M</span></div>
            <div className="flex justify-between"><span className="text-gray-400">Neurons/Head</span><span className="font-mono">8,192</span></div>
            <div className="flex justify-between"><span className="text-gray-400">BLEU (En→Fr)</span><span className="font-mono text-red-400">1.8</span></div>
            <div className="flex justify-between"><span className="text-gray-400">BLEU (En→Pt)</span><span className="font-mono text-green-400">29.7</span></div>
          </div>
        </motion.div>

        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="glass-card p-6 ring-2 ring-bdh-accent/30">
          <div className="flex items-center gap-2 mb-4">
            <span className="text-2xl">🌍</span>
            <h3 className="font-semibold text-bdh-accent">Merged Polyglot</h3>
          </div>
          <div className="space-y-3">
            <div className="flex justify-between"><span className="text-gray-400">Parameters</span><span className="font-mono">~50M</span></div>
            <div className="flex justify-between"><span className="text-gray-400">Neurons/Head</span><span className="font-mono">16,384</span></div>
            <div className="flex justify-between"><span className="text-gray-400">BLEU (En→Fr)</span><span className="font-mono text-green-400">31.9</span></div>
            <div className="flex justify-between"><span className="text-gray-400">BLEU (En→Pt)</span><span className="font-mono text-green-400">28.8</span></div>
          </div>
        </motion.div>
      </div>
