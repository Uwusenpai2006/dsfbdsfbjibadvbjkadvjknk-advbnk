...
for name, path in [('French', 'checkpoints/french_specialist/checkpoint_best.pt'),
                    ('Portuguese', 'checkpoints/portuguese_specialist/checkpoint_best.pt')]:
    ...
    with torch.no_grad():
        out = model.generate(ptokens, max_new_tokens=50, top_k=5, temperature=0.8)
